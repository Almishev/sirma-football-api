...
Backend application for the Sirma Academy task: **find the pair of football players who have played together in common matches for the longest time**, and the duration for each of those matches.

## Dependencies

- **spring-boot-starter-data-jpa** — JPA and persistence
